...
const Adventure = () => {
  ...
  const getMovies = () => {
    fetch(
      "https://api.themoviedb.org/3/discover/movie?api_key=cd03c49615cd326a66da1a5a7b3cc69e&language=en-US&sort_by=release_date.desc&page=1&with_genres=12"
    )
      .then((res) => res.json())
      .then((json) => {
              ...
              movie.poster_path && (
                ...
                >
                  <img
                    ...
                    alt=""
                    className="w-full max-w-[300px] h-[250px] rounded-lg"
                  />
